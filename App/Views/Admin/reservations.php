                        ...
                        <table class="w-full text-left text-sm whitespace-nowrap">
                            ...
                            <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                                ...
                                <?php endif; ?>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="font-bold text-slate-900 dark:text-white">#RES-9320</div>
                                        <div class="text-xs text-slate-500 mt-0.5">Booked Oct 10, 2023</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 font-bold text-xs">JD</div>
                                            <div>
                                                <div class="font-medium text-slate-900 dark:text-white">John Doe</div>
                                                <div class="text-xs text-slate-500">john.doe@example.com</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-900 dark:text-white">Tesla Model 3</div>
                                        <div class="text-xs text-slate-500 font-mono">ABC-1234</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 12, 10:00 AM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> LAX Airport
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 15, 10:00 AM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> LAX Airport
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-800/50">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button class="p-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 hover:text-slate-700 transition-colors" title="Edit">
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="font-bold text-slate-900 dark:text-white">#RES-9319</div>
                                        <div class="text-xs text-slate-500 mt-0.5">Booked Oct 09, 2023</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center text-purple-600 font-bold text-xs">SC</div>
                                            <div>
                                                <div class="font-medium text-slate-900 dark:text-white">Sarah Connor</div>
                                                <div class="text-xs text-slate-500">s.connor@future.net</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-900 dark:text-white">Ford Explorer</div>
                                        <div class="text-xs text-slate-500 font-mono">EXP-4567</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 20, 09:00 AM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> Downtown
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 22, 06:00 PM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> Downtown
                                        </div>
                                    </td>
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="font-bold text-slate-900 dark:text-white">#RES-9285</div>
                                        <div class="text-xs text-slate-500 mt-0.5">Booked Oct 08, 2023</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded-full bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center text-orange-600 font-bold text-xs">MK</div>
                                            <div>
                                                <div class="font-medium text-slate-900 dark:text-white">Michael Kyle</div>
                                                <div class="text-xs text-slate-500">m.kyle@sitcom.tv</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-900 dark:text-white">Toyota Camry</div>
                                        <div class="text-xs text-slate-500 font-mono">XYZ-9876</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 25, 02:00 PM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> LAX Airport
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 28, 11:00 AM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> LAX Airport
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-amber-50 dark:bg-amber-900/20 text-amber-600 dark:text-amber-400 border border-amber-100 dark:border-amber-800/50">
                                            Pending
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button class="p-1.5 rounded-md hover:bg-emerald-50 dark:hover:bg-emerald-900/30 text-emerald-500 hover:text-emerald-600 transition-colors" title="Approve">
                                                <span class="material-symbols-outlined text-[20px]">check</span>
                                            </button>
                                            <button class="p-1.5 rounded-md hover:bg-red-50 dark:hover:bg-red-900/30 text-red-500 hover:text-red-600 transition-colors" title="Reject">
                                                <span class="material-symbols-outlined text-[20px]">close</span>
                                            </button>
                                        </div>
                                    </td>
                                </tr>
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group opacity-75">
                                    <td class="px-6 py-4">
                                        <div class="font-bold text-slate-900 dark:text-white">#RES-9155</div>
                                        <div class="text-xs text-slate-500 mt-0.5">Booked Oct 01, 2023</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 font-bold text-xs">JB</div>
                                            <div>
                                                <div class="font-medium text-slate-900 dark:text-white">James Bond</div>
                                                <div class="text-xs text-slate-500">007@mi6.gov.uk</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-900 dark:text-white">BMW X5</div>
                                        <div class="text-xs text-slate-500 font-mono">LUX-8888</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 05, 08:00 AM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> Heathrow
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Oct 07, 08:00 PM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> Heathrow
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-800/50">
                                            Cancelled
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                ...
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                                    <td class="px-6 py-4">
                                        <div class="font-bold text-slate-900 dark:text-white">#RES-8999</div>
                                        <div class="text-xs text-slate-500 mt-0.5">Booked Sep 25, 2023</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="size-8 rounded-full bg-pink-100 dark:bg-pink-900/30 flex items-center justify-center text-pink-600 font-bold text-xs">EB</div>
                                            <div>
                                                <div class="font-medium text-slate-900 dark:text-white">Emily Blunt</div>
                                                <div class="text-xs text-slate-500">emily@hollywood.com</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-900 dark:text-white">Fiat 500</div>
                                        <div class="text-xs text-slate-500 font-mono">FUN-500</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Sep 28, 10:00 AM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> Rome
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-slate-700 dark:text-slate-300">Sep 30, 10:00 AM</div>
                                        <div class="text-xs text-slate-500 flex items-center gap-1">
                                            <span class="material-symbols-outlined text-[12px]">location_on</span> Rome
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700">
                                            Completed
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button class="p-1.5 rounded-md hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 hover:text-slate-700 transition-colors" title="Download Invoice">
